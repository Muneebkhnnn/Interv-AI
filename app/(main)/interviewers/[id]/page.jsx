    ...
    return (
        <main className="min-h-screen bg-black pt-16">
            ...
            <section className="relative border-b border-white/8 overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-8 pt-8 md:pt-10 pb-10 flex flex-col gap-5">
                    <Link href="/explore">
                        <Button
                            variant="link"
                            className="text-stone-400 hover:text-stone-200 cursor-pointer pl-0"
                        >
                            <ArrowLeft size={13} />
                            Back to explore
                        </Button>
