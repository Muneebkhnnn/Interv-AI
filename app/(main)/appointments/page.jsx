...
import AutoRefreshAppointments from "./AutoRefreshAppointments";
...
export default async function MyAppointmentsPage() {
  ...
  // chckng date is more than now and status is scheduled
  const scheduled = appointments.filter(
    (a) => a.status === "SCHEDULED" && new Date(a.startTime) > now
  );

  // everything else is past (either completed/cancelled or just already happened)
