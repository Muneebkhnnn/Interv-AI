...
export default async function Home() { 
  ...
  const href =
  !user?.role // new user when logins through clerk will not have a role, and hence he will be redierected to onboarding page where he will select his role and then his data will be saved in the database
    ? "/onboarding"
